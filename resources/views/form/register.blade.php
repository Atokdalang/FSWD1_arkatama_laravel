                    ...
                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                      ...
                      <form class="p-3 mt-3" action="{{url('/register')}}" method="post">
                        ...
                        <div class="d-flex justify-content-start mx-4 mb-3 mb-lg-4">
                            <button type="submit" class="btn btn-primary btn-sm mx-2">Register</button>
                            <a class="btn btn-primary btn-sm" href = '{{url('/login')}}'>Return</a>
                          </div>
                      </form>
